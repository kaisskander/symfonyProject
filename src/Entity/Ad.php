...
class Ad
{
    ...
    /**
     * permet de recupere le commentaire d'au auteur par rapport a une annonce
     * @param User $author
     * @return mixed|null
     */
     ...
     * @return  array Un tableau d'objet date time
     */
    ...
    public function getNotAvailableDays()
    {
        ...
        foreach ($this->bookings as $booking){
            //calculer les jours qui se trouvent entre la d'ate d'arrivée et de depart
            $resultat = range(
